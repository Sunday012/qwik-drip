...
const SlideTextContent: React.FC<SlideTextContentProps> = ({ title, description, icon }) => {
  return (
...
export const SlideSection: React.FC = () => {
  ...
  const slides: SlideData[] = [
    { 
      ...
      description: "Get personalized style insights and recommendations based on your preferences and fashion choices.",
      icon: "/icons/star.svg",
    ...
    { 
      ...
      description: "Organize and track your outfits with intelligent bookmarking and categorization.",
    ...
    { 
      ...
      description: "Active creators earn bonus rewards and exclusive partnership opportunities.",
      icon: "/icons/rank.svg",
    ...
    { 
      ...
      description: "Turn your style into success. Buy trending outfits or sell your fashion combinations instantly on our marketplace.",
      icon: "/icons/cart.svg",
  ...
  useEffect(() => {
    ...
    const handleScroll = (): void => {
      ...
      const normalizedScroll = Math.max(0, Math.min(1, (scrollY - sectionTop) / effectiveHeight));
  ...
  return (
    ...
    >
      ...
      <div className="sticky top-0 h-screen flex items-center justify-center py-40">
        <div className="flex flex-col justify-center gap-4 py-[60px] md:flex-row md:items-start w-full">
          {/* Left side with changing content */}
          <div className="relative w-full h-[165px] md:w-[40%]">
            {slides.map((slide, index) => (
              <div 
                key={slide.id}
                className="slide-content absolute w-full transition-all duration-4000"
                style={{
          ...
          <div className="flex items-center justify-center w-full md:w-[50%]">
            <div className="mt-6 flex h-[430px] w-[80%] items-center justify-center rounded-[59px] border-t-[9px] border-t-[#FFFFFF05] bg-[#6600FF0D] md:mt-0 relative overflow-hidden">
              {slides.map((slide, index) => (
                <img 
                  key={slide.id}
                  src={slide.image} 
                  alt="" 
                  className="absolute transition-all duration-4000 h-[390px] w-[219px]"
                  style={{
                    opacity: getSlideOpacity(index),
