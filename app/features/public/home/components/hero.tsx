...
export function Hero() {
  return (
    <div className="relative flex min-h-screen flex-col flex-wrap gap-10 rounded-bl-[24px] rounded-br-[24px] px-4 py-16 text-[#E9E9E9] sm:rounded-bl-[80px] sm:rounded-br-[80px] sm:px-[5%] sm:py-[7%] lg:flex-row lg:gap-0">
      ...
      <div className="xs:mt-[100px] sm:-translate-x-1/1 z-20 mx-auto mt-[160px] flex h-[80px] w-[80px] items-center justify-center rounded-[50%] bg-white text-4xl text-[#3085d4] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.3),0px_8px_12px_6px_rgba(0,0,0,0.15)] md:absolute md:mt-0 sm:h-[120px] sm:w-[120px] md:right-1/4 md:top-1/4 md:-translate-x-1/4 md:-translate-y-1/4 lg:mt-[100px]">
        <PiPlayFill />
      </div>
      ...
      <div className="z-[3] my-[3%] w-full sm:mt-[20%] lg:mt-[8%] lg:w-[48%]">
        ...
        <div className="mb-[24px] w-full sm:mb-[32px] sm:w-[90%]">
          <h2 className="xs:text-[34px] mb-[24px] mt-[16px] text-[40px] font-bold leading-tight text-white sm:w-11/12 sm:text-[40px] sm:leading-9 lg:w-auto lg:text-[48px] xl:text-[64px] xl:leading-[69px]">
            Weight loss <br /> Treatment for a <br /> Unique you
          </h2>
          <p className="xs:text-sm mb-6 text-base font-medium text-[rgba(255,255,255,0.74)] sm:w-10/12 sm:text-xl lg:w-auto">
